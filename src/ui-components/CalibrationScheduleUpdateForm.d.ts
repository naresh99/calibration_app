...
export declare type CalibrationScheduleUpdateFormInputValues = {
...
export declare type CalibrationScheduleUpdateFormValidationValues = {
...
export declare type CalibrationScheduleUpdateFormOverridesProps = {
    CalibrationScheduleUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type CalibrationScheduleUpdateFormProps = React.PropsWithChildren<{
    overrides?: CalibrationScheduleUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    calibrationSchedule?: any;
    onSubmit?: (fields: CalibrationScheduleUpdateFormInputValues) => CalibrationScheduleUpdateFormInputValues;
    onSuccess?: (fields: CalibrationScheduleUpdateFormInputValues) => void;
    onError?: (fields: CalibrationScheduleUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: CalibrationScheduleUpdateFormInputValues) => CalibrationScheduleUpdateFormInputValues;
    onValidate?: CalibrationScheduleUpdateFormValidationValues;
} & React.CSSProperties>;
export default function CalibrationScheduleUpdateForm(props: CalibrationScheduleUpdateFormProps): React.ReactElement;
